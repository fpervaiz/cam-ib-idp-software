...
victim_detection_region = np.array([[43, 12],[395, 13],[386, 156],[267, 162],[265, 303],[379, 300],[380, 462],[46, 463]], np.int32).reshape((-1,1,2))
triage_region = np.array([[428, 345], [563, 339], [562, 478], [423, 479]], np.int32).reshape((-1,1,2))

victim_contour_min_area = 25

risk_zone_upper = np.array([[388, 19],[382, 161],[203, 160],[194, 21]], np.int32).reshape((-1,1,2))
risk_zone_lower = np.array([[218, 320],[368, 315],[371, 452],[204, 449]], np.int32).reshape((-1,1,2))
